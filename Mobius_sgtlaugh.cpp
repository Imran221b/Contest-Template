...
/// Definition: Square free number is a number which doesn't have a prime factor in 
/// its prime factorization more than once (Therefore not divisible by a square number other than 1)
...
void Mobius(){ // This one is fastest of the three
    mu[1] = 1;
    int i, j, k;
